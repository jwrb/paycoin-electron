...
Settings.prototype.backupButton = function backupButton() {
  var self = this
  return h('button.btn.btn-primary.btn-block.no-radius',
        { onclick: function(e) {
            self.backupWallet();
          }
          , 'name': 'backupButton'
...
Settings.prototype.backupWallet = function backupWallet() {
  return false
}
